...
export default function Lobby({ onEnter, setName }: LobbyProps) {
    ...
    const colors = [
        ...
        { name: "Turquesa", value: "#14b8a6", bg: "bg-teal-500" },
        { name: "Limão", value: "#84cc16", bg: "bg-lime-500" },
        { name: "Violeta", value: "#7c3aed", bg: "bg-violet-500" },
        { name: "Marrom", value: "#a16207", bg: "bg-amber-800" },
    ];
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-3 flex-col md:flex-row">
                            ...
                            <button
                                ...
                                className="px-6 bg-linear-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold py-3 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                            >
                                Entrar
                            </button>
                        </div>
